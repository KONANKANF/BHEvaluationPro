...
public class FonctionServiceImpl extends AbstractBaseRepositoryImpl<Fonction, Long> implements FonctionService {
	...
	public List<FonctionDto> getAll() throws SQLException {
		log.info("-- Get all entities Fonction : Begin --");
		try {
			log.info("-- All entities Fonction get successfully --");
	...
	@Override
	public Optional<Fonction> findById(Long id) throws SQLException {
	...
	@Override
	@Transactional
	public void deleteEntity(FonctionDto entityDto) throws SQLException {
